public class Console extends Device {
    ...
    private String category; // The category of the console

    // The constructor for the Console class
    public Console(String type, String cpu, String gpu, String sound, int storage, String code, String name, int manuyear, String manufacture, int price, int quantity) {
        // Call the superclass constructor with relevant parameters
        super("Console", code, name, manuyear, manufacture, price, quantity, type, "Gaming");
