public class TV extends Device {
    ...
    public TV(String type, int dimension, int resolution, String port, String code, String name, int manuyear, String manufacture, int price, int quantity) {
        // Call the superclass constructor with relevant parameters
        super("TV", code, name, manuyear, manufacture, price, quantity, type, "Picture and Sound");
