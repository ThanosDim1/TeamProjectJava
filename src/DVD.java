public class DVD extends Device {
    ...
    private String category; // The category of the DVD

    // The constructor for the DVD class
    public DVD(String type, int res, String format, String code, String name, int manuyear, String manufacture, int price, int quantity) {
        // Call the superclass constructor with relevant parameters
        super("DVD", code, name, manuyear, manufacture, price, quantity, type, "Picture and Sound");
