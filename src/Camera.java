public class Camera extends Device {
    ...
    public Camera(String type, int mp, int opticalzoom, int digitalzoom, String dim, String code, String name, int manuyear, String manufacture, int price, int quantity) {
        // Call the superclass constructor with relevant parameters
        super("Camera", code, name, manuyear, manufacture, price, quantity, type, "Picture and Sound");
