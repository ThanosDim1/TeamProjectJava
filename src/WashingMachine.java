public class WashingMachine extends Device {
    ...
    public WashingMachine(String energyclass, int storage, int rpm, String code, String name, int manuyear, String manufacture, int price, int quantity) {
        // Call the superclass constructor with relevant parameters
        super("Washing Machine", code, name, manuyear, manufacture, price, quantity, "Washing Machine", "Household Appliances");
