public class Fridge extends Device {
    ...
    private String category; // The category of the fridge

    // The constructor for the Fridge class
    public Fridge(String type, String energyclass, int mainstorage, int freezerstorage, String code, String name, int manuyear, String manufacture, int price, int quantity) {
        // Call the superclass constructor with relevant parameters
        super("Fridge", code, name, manuyear, manufacture, price, quantity, type, "Household Appliances");
